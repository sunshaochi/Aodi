 ...
 * 销售概览
 * **/
public class SxglFrag extends NewBaseFrag{
	...
	private OverviewOperativeFragment yyfra;//运营
	private OverviewProfitFragment ylfra;//盈利
	private OverviewKcFrag kcfra;//库存
	private int type;//用来区分是在当前那个fragment里面
//	private DemoFra demofra;
	...
	private void slectfra(int i) {
		// TODO Auto-generated method stub
            ...
            case 0://运营
            	type=0;
                if(yyfra==null){
                	yyfra=new OverviewOperativeFragment ();
                    transaction.add(R.id.overview_fragment_layout,yyfra);                                     
                }else {
            ...
            case 1://库存
            	type=1;
                if(kcfra==null){
                	kcfra=new OverviewKcFrag();
                    transaction.add(R.id.overview_fragment_layout,kcfra);
            ...
            case 2://盈利
            	type=2;
                if(ylfra==null){
                	ylfra=new OverviewProfitFragment();
                    transaction.add(R.id.overview_fragment_layout,ylfra);
