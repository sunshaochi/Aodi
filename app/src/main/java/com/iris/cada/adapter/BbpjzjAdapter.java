...
public class BbpjzjAdapter extends BaseAdapter{
	private Context context;
	private List<BbkcBean> zjlist;// 总计集合
	private List<BbkcBean> pjlist;// 平均集合
	
	
	

	public BbpjzjAdapter(Context context, List<BbkcBean> zjlist, List<BbkcBean> pjlist) {
		super();
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (zjlist != null && zjlist.size() != 0 && pjlist != null && pjlist.size() != 0) {
			if (arg0 == 0) {
				...
				viewHolder.newpotential.setText(zjlist.get(0).getZtsl());
				viewHolder.firstDrive.setText(zjlist.get(0).getZksl());
				viewHolder.quotation.setText(zjlist.get(0).getKcsl());
				viewHolder.indent.setText(zjlist.get(0).getPjkcts());
				viewHolder.ll_item.setBackgroundColor(Color.parseColor("#ffffff"));
			} else if (arg0 == 1) {
				viewHolder.salesconsultant.setText("平均");
				viewHolder.newpotential.setText(pjlist.get(0).getZtsl());
				viewHolder.firstDrive.setText(pjlist.get(0).getZksl());
				viewHolder.quotation.setText(pjlist.get(0).getKcsl());
				viewHolder.indent.setText(pjlist.get(0).getPjkcts());
