        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_SET_ALIAS:
                    ...
                    //调用JPush 新接口来设置别名
                    JPushInterface.setAlias(ProfitApplication.getApplication(), 0, (String) msg.obj);
                    break;
//                default:
//                    LogUtils.e("Unhandled msg - " + msg.what);
    ...
    public void onAliasOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        if (jPushMessage.getErrorCode() == 0) {
//           MyToast.makeText(ProfitApplication.getApplication(), "可以调到主界面了", 1).show();        	
//        	Intent intent1 = new Intent(context,SeparateAct.class);	
//			intent1.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//			context.startActivity(intent1);
//			AppManager.getAppManager().finishActivity(LoginActivity.class);
        } else {
        	Log.e("失败状态", jPushMessage.getErrorCode()+"");
