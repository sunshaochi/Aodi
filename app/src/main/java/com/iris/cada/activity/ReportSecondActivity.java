...
public class ReportSecondActivity extends BaseActivity {
	...
	public void initView() {
		...
		// 获取报表信息
		IS_DAY = ExhibitionFragment.IS_DAY;
		IS_VP_FIRST = ExhibitionFragment.IS_VP_FIRST;
		...
		llReportTitleParent = (LinearLayout) findViewById(R.id.ll_exhibition_title_parent);
		...
		// 初始化底部button
		// 初始化listview
		listReportNumber1Container = inflate.inflate(R.layout.listview_exhibition_number1, null);
		listReportNumber2Container = inflate.inflate(R.layout.listview_exhibition_number2, null);
		listReportNumber3Container = inflate.inflate(R.layout.listview_exhibition_number3, null);
		listReportNumber4Container = inflate.inflate(R.layout.listview_exhibition_number4, null);
	...
	public void exetuceRequest() {
		/*
		 * http://120.26.66.145:7522/cadaService/GetILogReportServlet?date=
		 * 2015 -12-31&license=sallygo&role=经销商&brand=奥迪&mode=否
		 */
		...
		if (IS_DAY) {
			...
			new Thread(new Runnable() {
				...
				@Override
				public void run() {
					jsons = IRISService.doReport(date, licence, "经销商", ProfitApplication.salesInfo.getBrand(), carModel);
					if (jsons != null) {
