...
public class HelpAct extends FragmentActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.rl_xs:
			startActivity(new Intent(HelpAct.this,  HelpDocumentActivity.class));
			break;

		case R.id.rl_sh:
			startActivity(new Intent(HelpAct.this,  ShHelpAct.class));
			break;
