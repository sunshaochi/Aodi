 ...
 */
public class OperatecloserateDesc implements Comparator<IViewOperateReport> {

	@Override
	public int compare(IViewOperateReport lhs, IViewOperateReport rhs) {
		return StringUtils.intStringComparator(lhs.getCloserate(), rhs.getCloserate(), false);
