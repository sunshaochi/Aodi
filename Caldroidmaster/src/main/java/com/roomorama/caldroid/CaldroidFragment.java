...
public class CaldroidFragment extends DialogFragment {
	 ...
	 */
	private static final int MONTH_YEAR_FLAG = DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_NO_MONTH_DAY
	 ...
	 * Initial params key
	 */
	public final static String DIALOG_TITLE = "dialogTitle", MONTH = "month", YEAR = "year",
			SHOW_NAVIGATION_ARROWS = "showNavigationArrows", DISABLE_DATES = "disableDates",
			SELECTED_DATES = "selectedDates", MIN_DATE = "minDate", MAX_DATE = "maxDate", ENABLE_SWIPE = "enableSwipe",
			START_DAY_OF_WEEK = "startDayOfWeek", SIX_WEEKS_IN_CALENDAR = "sixWeeksInCalendar",
			ENABLE_CLICK_ON_DISABLED_DATES = "enableClickOnDisabledDates", SQUARE_TEXT_VIEW_CELL = "squareTextViewCell",
			THEME_RESOURCE = "themeResource";

	/**
	 * For internal use
	 */
	public final static String _MIN_DATE_TIME = "_minDateTime", _MAX_DATE_TIME = "_maxDateTime",
	 ...
	 * @param dialogTag
	 */
	public void restoreDialogStatesFromKey(FragmentManager manager, Bundle savedInstanceState, String key,
			String dialogTag) {
		...
		if (dateItemClickListener == null) {
			dateItemClickListener = new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					if (caldroidListener != null&&(dateTime.getMonth()==pageChangeListener.getCurrentDateTime().getMonth())) {
	...
	protected void refreshMonthTitleTextView() {
		...
		String monthTitle = DateUtils
				.formatDateRange(getActivity(), monthYearFormatter, millis, millis, MONTH_YEAR_FLAG).toString();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		// This is a hack to fix issue localInflater doesn't use the
		// themeResource, make Android
		// complain about layout_width and layout_height missing. I'm unsure
		// about its impact
	...
	public RelativeLayout getRelativeLayoutBtm() {
		return rl_bottom;
	}
	...
	public class DatePageChangeListener implements OnPageChangeListener {
		...
		public void refreshAdapters(int position) {
			...
			if (position == currentPage) {
				...
				prevAdapter
						.setAdapterDateTime(currentDateTime.minus(0, 1, 0, 0, 0, 0, 0, DateTime.DayOverflow.LastDay));
