...
import com.iris.foundation.activity.FoundationActivity;
...
public class SlidingFragmentActivity extends FoundationActivity implements SlidingActivityBase{
	...
	public void switchConent(Fragment fragment, int id) {
		super.switchConent(fragment, id);
		showContent();
	}
}
